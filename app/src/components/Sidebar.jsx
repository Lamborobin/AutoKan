    ...
    <div className="mt-1 mb-2 mx-1 bg-surface-3 border border-border rounded-xl p-3 space-y-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <button onClick={onEdit} className="text-accent hover:text-accent/80 transition-colors p-1 rounded-md" title="Edit agent">
            <Pencil size={11} />
          </button>
...
function SectionHeader({ onBack, title, onClose }) {
  return (
    <div className="flex items-center gap-2 px-4 py-4 border-b border-border">
      <button onClick={onBack} className="btn-ghost p-1.5 rounded-lg text-gray-400 hover:text-gray-200">
      ...
      <aside className="w-64 bg-surface-1 border-r border-border flex flex-col shrink-0">
        ...
        <nav className="p-3 space-y-1 border-b border-border">
          ...
          {archivedTasks.length > 0 && (
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-gray-400 hover:text-gray-200 hover:bg-surface-3 text-sm transition-colors"
            >
        ...
        <div className="flex-1 overflow-y-auto p-3">
          <button
            ...
            className="w-full flex items-center justify-between px-1 py-1 mb-1.5 text-sm font-semibold text-gray-400 hover:text-gray-200 transition-colors uppercase tracking-widest"
          >
